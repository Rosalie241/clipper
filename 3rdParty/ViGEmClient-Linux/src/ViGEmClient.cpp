...
PVIGEM_CLIENT vigem_alloc(void)
{
	...
	libevdev_enable_event_code(client, EV_KEY, BTN_DPAD_UP, nullptr);
	libevdev_enable_event_code(client, EV_KEY, BTN_DPAD_DOWN, nullptr);
	libevdev_enable_event_code(client, EV_KEY, BTN_DPAD_LEFT, nullptr);
	libevdev_enable_event_code(client, EV_KEY, BTN_DPAD_RIGHT, nullptr);
